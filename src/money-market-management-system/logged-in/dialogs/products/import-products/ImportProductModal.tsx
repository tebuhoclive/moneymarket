...
const ImportProductModal = observer(() => {
  const onCancel = () => {
  ...
  return (
    <div className="upload-deduction-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      ...
      <h3 className="uk-modal-title">Import Products</h3>
      ...
      <div className="dialog-content uk-position-relative">
        <form
          ...
          data-uk-grid
        >
          <p>This form allows you to import <b>Products</b> excel files that have been exported from the old system.</p>
          <ImportProductForm/>
