...
import { getUniversalBankCode, allBanks } from "../../../../../shared/functions/Banks";
...
const LegalBankAccountImportForm = observer(() => {
  ...
  const handleAccountImport = async () => {
    if (importFile) {
      ...
      try {
        ...
        const response = await fetch("https://us-central1-ijgmms.cloudfunctions.net/importLegalEntityBankAccount",
          {
            method: "POST",
            headers: {
...
export default LegalBankAccountImportForm;
