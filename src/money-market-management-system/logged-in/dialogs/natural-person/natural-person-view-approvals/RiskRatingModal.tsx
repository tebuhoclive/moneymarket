...
const RiskRatingModal = observer(() => {
        ...
        swal({
            ...
            if (edit) {
                ...
                const auditTrail: INaturalPersonAuditTrail = {
                    ...
                    actionDescription: `update risk rating from ${client.riskRating === "" ? 'Not Risk Rated' : client.riskRating} to ${_client.clientRiskRating}`,
    ...
    return (
        <div className="custom-modal-style uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-width-2-3">
            ...
            <h4 className="main-title-lg">Client Risk Rating</h4>
            <hr />
