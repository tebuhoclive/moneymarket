...
interface IProps {
    ...
    onSubmitComplianceDetails: (e: FormEvent<HTMLFormElement>) => void;
    onBackToClientInformation: () => void;
}

export const ComplianceForm = observer((props: IProps) => {
    const { client, setClient, onSubmitComplianceDetails, onBackToClientInformation } = props;
    ...
    return (
        <ErrorBoundary>
            <form className="uk-form-stacked uk-grid-small" data-uk-grid
                onSubmit={onSubmitComplianceDetails}>
                ...
                <div className="uk-width-1-1 uk-text-right">
                    <button className="btn btn-warning" type="button" onClick={onBackToClientInformation}>Back</button>
                    {/* <button className="btn btn-danger" type="button">Save As Draft</button> */}
