...
export const BankAccountDetailsForm = observer((props: IBankAccountDetailProps) => {
    const { client, setClient, onSubmitBankAccountInformation, onBackToClientFinancialProfile } = props;
        ...
        <ErrorBoundary>
            <form className="uk-form-stacked uk-grid-small" data-uk-grid onSubmit={onSubmitBankAccountInformation}>
                ...
                <div className="uk-width-1-1 uk-margin-top-small">
                    ...
                    <hr className="uk-width-1-1 uk-margin-top-remove" />
                </div>
                ...
                <div className="uk-width-1-1 uk-text-right">
                    <button className="btn btn-danger" type="button" onClick={onBackToClientFinancialProfile}>
                        Back
                    </button>
