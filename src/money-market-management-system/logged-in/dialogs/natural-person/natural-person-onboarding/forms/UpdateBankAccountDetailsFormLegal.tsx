...
export const UpdateBankAccountDetailsFormLegal = observer((props: IBankAccountDetailProps) => {
    const { client, loading, setClient, onSubmitAccountDetail } = props;
    ...
    return (
        <ErrorBoundary>
            <form className="uk-form-stacked uk-grid-small" data-uk-grid onSubmit={onSubmitAccountDetail}>
