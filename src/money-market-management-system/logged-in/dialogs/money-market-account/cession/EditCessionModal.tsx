...
const EditCessionModal = observer(() => {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                if (store.cessionInstruction.selected) {
                    const selectedCession = store.cessionInstruction.selected
                    setCession(selectedCession);
                }
        ...
        loadData();
    }, [store.cessionInstruction.selected]);
...
export default EditCessionModal
