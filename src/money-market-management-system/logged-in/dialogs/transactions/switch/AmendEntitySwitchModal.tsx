...
import DeleteEntitySwitchModal from "./DeleteEntitySwitchModal";
...
const AmendEntitySwitchModal = observer(({ setVisible }: IProps) => {
  ...
  const onDelete = () => {
    ...
    showModalFromId(MODAL_NAMES.BACK_OFFICE.DELETE_SWITCH_ENTITIES_MODAL);
  };
  const onCancel = () => {
    setSwitchTransaction({ ...defaultSwitchTransaction });
    setSwitchTransactionTo({ ...defaultSwitchTransaction });
    setVisible(false);
    hideModalFromId(MODAL_NAMES.BACK_OFFICE.SWITCH_BETWEEN_ENTITIES_AMEND_MODAL);
    setSelectedClient(null);
    setSelectedClientTo(null);
    setSelectedClientAccountNumberTo({ label: "", value: "" })
    setSelectedClientAccountNumber({ label: "", value: "" })
      ...
      <div className="view-modal custom-modal-style uk-modal-dialog uk-modal-body uk-width-4-5">
        ...
        <div className="form-title">
          ...
          <h3 className="text-to-break" style={{ marginLeft: "2rem" }}>
            Amend Manual Switch Transaction
          </h3>
        </div>
        <hr />
        ...
        <Modal modalId={MODAL_NAMES.BACK_OFFICE.DELETE_SWITCH_ENTITIES_MODAL}>
          {showOnSubmitModal && <DeleteEntitySwitchModal setVisible={setShowOnSubmitModal} />}
        </Modal>
      </div>
    </ErrorBoundary>
  );
...
export default AmendEntitySwitchModal;
