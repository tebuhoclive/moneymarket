...
const ReturnSwitchCloseOutForAmendmentModal = observer(({ setVisible }: IProps) => {
  ...
  const onCancel = () => {
    ...
    hideModalFromId(MODAL_NAMES.BACK_OFFICE.RETURN_SWITCH_CLOSE_OUTS_FOR_AMENDMENT);
    setLoading(false);
    setVisible(false);
  };
  useEffect(() => {
...
export default ReturnSwitchCloseOutForAmendmentModal;
