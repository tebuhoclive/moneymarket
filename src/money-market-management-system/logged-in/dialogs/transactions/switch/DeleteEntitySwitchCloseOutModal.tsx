...
const DeleteEntitySwitchCloseOutModal = observer(({ setVisible }: IProps) => {
  ...
  const onDelete = () => {
    swal({
      ...
      if (edit) {
        ...
        swal({
          icon: "success",
          text: "Switch Submitted For Approval",
        });
        onCancel();
      }
    });
  ...
  const onCancel = () => {
    ...
    hideModalFromId(MODAL_NAMES.BACK_OFFICE.DELETE_SWITCH_CLOSE_OUT_ENTITIES_MODAL);
    setLoading(false);
    setVisible(false);
  };
  useEffect(() => {
              ...
              <div className="uk-child-width-1-3@m uk-grid-small uk-grid-match" data-uk-grid>
                <div className="uk-width-1-1">
                  ...
                  <form className="uk-grid uk-grid-small" data-uk-grid>
                    ...
                    <div className="uk-width-1-2">
                      <div className="uk-width-1-1">
                        <label className="uk-form-label uk-display-block required">Reason For Not Deleting</label>
                        <textarea
...
export default DeleteEntitySwitchCloseOutModal;
