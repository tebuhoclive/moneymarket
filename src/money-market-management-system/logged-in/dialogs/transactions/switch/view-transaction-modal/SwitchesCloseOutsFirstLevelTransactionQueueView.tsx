...
import ReturnSwitchCloseOutForAmendmentModal from "../ReturnSwitchCloseOutForAmendmentModal";
...
const SwitchesCloseOutsFirstLevelTransactionQueueView = observer(({ setVisible }: IProps) => {
    ...
    const submitForFirstLevelApproval = () => {
        swal({
            title: "Are you sure?",
            icon: "warning",
    ...
    const onReturnForAmendment = () => {
        ...
        showModalFromId(MODAL_NAMES.BACK_OFFICE.RETURN_SWITCH_CLOSE_OUTS_FOR_AMENDMENT);
    }
    const onCancel = () => {
    ...
    return (
        <ErrorBoundary>
            <div className="view-modal custom-modal-style uk-modal-dialog uk-modal-body uk-width-4-5">
                ...
                <Modal
                    modalId={
                        MODAL_NAMES.BACK_OFFICE.RETURN_SWITCH_CLOSE_OUTS_FOR_AMENDMENT
                    }>
                    {showOnSubmitModal && <ReturnSwitchCloseOutForAmendmentModal setVisible={setShowOnSubmitModal} />
                    }
                </Modal>
            </div>
        </ErrorBoundary>
...
export default SwitchesCloseOutsFirstLevelTransactionQueueView;
