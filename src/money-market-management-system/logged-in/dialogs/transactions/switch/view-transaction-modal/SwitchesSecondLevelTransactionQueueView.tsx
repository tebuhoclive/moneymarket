...
import { onCompletedSwitch } from "../../client-deposit-allocation/view-transaction-modal/complete-transaction-process/ProcessTransactions";
import { processSwitchTransactions } from "../../../../system-modules/money-market-transactions-module/switch-between-accounts/switch-status/procsssing/ProcessSwitchTransactions";
...
const SwitchesSecondLevelTransactionQueueView = observer(({ setVisible }: IProps) => {
                ...
                if (fromAccount && toAccount && switchTransaction.switchAction !== "Deleted") {
                    if (futureDatingTransaction) {
                        const _switchTransaction: ISwitchTransaction = {
                            ...
                            valueDate: switchTransaction.valueDate,
                        ...
                        try {
                            ...
                            // onCompletedSwitch(_switchTransaction, api, store)
                            await processSwitchTransactions(_switchTransaction, api, store);
                        } catch (error) {
...
export default SwitchesSecondLevelTransactionQueueView;
