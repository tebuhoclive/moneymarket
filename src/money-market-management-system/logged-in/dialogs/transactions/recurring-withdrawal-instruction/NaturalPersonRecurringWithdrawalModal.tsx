...
// } from "../../../../../shared/models/clients/NaturalPersonModel";
// import {
...
// const NaturalPersonRecurringWithdrawalModal = observer(
...
//     if (selectedClient && selectedClient.bankingDetail) {
//       if (Array.isArray(selectedClient.bankingDetail)) {
//         // Test environment: bankDetails is an array of maps
//         bankAccounts = selectedClient.bankingDetail.map((bankDetail: any) => ({
//           label: `${bankDetail.bankName} | ${bankDetail.accountNumber} | ${bankDetail.accountHolder} | ${bankDetail.branchNumber}`,
//           value: `${bankDetail.bankName} | ${bankDetail.accountNumber} | ${bankDetail.accountHolder} | ${bankDetail.branchNumber}`,
//         }));
//       } else if (typeof selectedClient.bankingDetail === "object") {
//         // Live environment: bankDetails is a map
//         const { bankName, accountHolder, accountNumber, branchNumber } =
//           selectedClient.bankingDetail;
...
//         // Add the label and value to the bankAccounts array
//         bankAccounts.push({ label, value });
//       }
//     }
...
//         // const email = MAIL_DEPOSIT_PROCESSED_NOTIFICATION(
//         //   getClientName(clientWithdrawal, store),
//         //   clientWithdrawal.bank,
//         //   clientWithdrawal.amount
//         // );
//         // await api.mail.sendMail(
//         //   ["maunda@ijg.net", "ict@lotsinsigts.com"],
//         //   "no-reply@ijgmms.net",
//         //   "Processed Deposit Notification",
//         //   email.BODY
//         // );
//         swal({
//           icon: "success",
...
//     const onCancel = () => {
//       hideModalFromId(
//         MODAL_NAMES.BACK_OFFICE.RECORD_WITHDRAWAL_RECURRING_MODAL
//       );
...
//         setSelectedClientAccount(store.mma.selected);
//       }
//     }, [store.mma.selected]);
...
//                     <div className="uk-width-2-3">
//                       <p
//                         className={`${availableBalance < 0 ? "text-danger uk-text-bold" : ""
//                           }`}>
...
// export default NaturalPersonRecurringWithdrawalModal;

import React from 'react'

const NaturalPersonRecurringWithdrawalModal = () => {
  return (
    <div>
