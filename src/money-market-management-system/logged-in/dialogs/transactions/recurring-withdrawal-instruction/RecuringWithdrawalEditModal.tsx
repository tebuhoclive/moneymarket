...
// const NewRecurringEditWithdrawalModal = observer((props: ITransactionInstructionsProps) => {
...
// export default NewRecurringEditWithdrawalModal;

import React from 'react'

const RecuringWithdrawalEditModal = () => {
  return (
    <div>
...
export default RecuringWithdrawalEditModal
