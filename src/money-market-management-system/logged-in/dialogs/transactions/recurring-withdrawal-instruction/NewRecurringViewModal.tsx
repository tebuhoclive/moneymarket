...
// const NewRecurringViewWithdrawalModal = observer(
...
// export default NewRecurringViewWithdrawalModal;

import React from 'react'

const NewRecurringViewModal = () => {
  return (
    <div>
...
export default NewRecurringViewModal
