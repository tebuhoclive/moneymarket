...
import { WithdrawalTransactionAuditTrailGrid } from "../../../../system-modules/money-market-transactions-module/withdrawal-transaction/WithdrawalTransactionAuditTrailGrid";
...
const WithdrawalPaymentBatchTransactionView = observer(() => {
            ...
            <div className="view-modal custom-modal-style uk-modal-dialog uk-width-4-5">
                ...
                <div className="dialog-content uk-position-relative uk-flex uk-flex-column uk-flex-nowrap uk-width-auto uk-height-auto">
                    ...
                    {selectedTab === "Audit-Trail" && (
                        <WithdrawalTransactionAuditTrailGrid
                            data={withdrawalTransactionAudit} displayDetails={function (value: SetStateAction<boolean>): void {
                                throw new Error("Function not implemented.");
                            }} setSelectedAudit={function (value: SetStateAction<IWithdrawalTransactionAudit>): void {
                                throw new Error("Function not implemented.");
                            }} />
                    )}
...
export default WithdrawalPaymentBatchTransactionView;