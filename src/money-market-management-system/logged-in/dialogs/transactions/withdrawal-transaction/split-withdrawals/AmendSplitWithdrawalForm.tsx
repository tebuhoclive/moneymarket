...
import { SplitWithdrawalAllocationSheetAmend } from "./SplitWithdrawalAllocationSheetAmend";
interface FormProps {
  handleSubmit: () => void;
...
const AmendSplitWithdrawalForm: React.FC<FormProps> = observer(
  ({
    onCancel,
    handleSave,
    handleSubmit,
    ...
    useEffect(() => {
      setSelectedValues(splitTransactions.map(transaction => transaction.accountNumber || ""));
    }, [splitTransactions]);
    console.log("My set Values ", selectedValues)
    useEffect(() => {
    ...
    }, [clientBankingDetailsAccounts]);
    console.log("My used splits ",splitTransactions)
    return (
      <form className="ijg-form">
              ...
              <table className="split-kit-table-borderless">
                ...
                <tbody>
                  {splitTransactions.map((split, index) => (
                    <Fragment key={index}>
                      <SplitWithdrawalAllocationSheetAmend
                        index={index}
        ...
        <div className="uk-text-right">
          ...
          <button disabled={loadingSave || loading} type="button" className="btn btn-danger" onClick={onDelete}>
            Delete
          </button>
...
export default AmendSplitWithdrawalForm;