...
// import {
//   IRecurringWithdrawalInstruction, defaultRecurringWithdrawalInstruction
...
//           (client) => client.asJson.accountNumber === clientWithdrawal.allocation
//         );
...
//       }
//     }
//   }, [api.recurringWithdrawalInstruction.getAll, clientAccount, clientWithdrawal, store.client.legalEntity.all, store.client.naturalPerson.all, store.recurringWithdrawalInstruction.selected]);
...
//     };
//     loadData();
//   }, [ store.client.legalEntity.isEmpty, store.client.naturalPerson.isEmpty, store.mma.isEmpty, api.recurringWithdrawalInstruction, clientWithdrawal.id]);
...
//                           handleRecurringStatus(); // Call your function
//                         }}>
//                         Stop
//                       </button>
//                     }
...
export default ViewRecurringWithdrawal
