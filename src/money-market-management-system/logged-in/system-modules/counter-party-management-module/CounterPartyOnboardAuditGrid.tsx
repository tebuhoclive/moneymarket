...
import { ICounterPartyOnboardAudit } from "../../../../shared/models/clients/counter-party/CounterPartyOnboardAuditModel";
import { dateFormat_YY_MM_DD } from "../../../../shared/utils/utils";

interface IProps {
    data: ICounterPartyOnboardAudit[];
}

export const CounterPartyOnboardAuditTrailGrid = observer(({ data }: IProps) => {
    const { store } = useAppContext();

    const users = store.user.all;

    const getActionUser = (auditTrail: ICounterPartyOnboardAudit) => {
        if (users) {
