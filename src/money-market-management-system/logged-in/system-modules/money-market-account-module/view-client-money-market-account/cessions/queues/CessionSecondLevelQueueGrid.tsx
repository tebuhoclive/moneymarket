...
const CessionSecondLevelQueueGrid = observer((props: IProps) => {
        ...
        for (const cession of selectedCessions) {
            if (cession.amount !== 0) {
                ...
                const audit: ICessionInstructionAuditTrail = {
                    action: "Approved Second Level",
                    actionDescription: "Cession Instruction has been approved (second level approval)",
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <>
                        <IconButton data-uk-tooltip="Edit Cession"
                        // onClick={() => onAmendDepositCession(params.row, store, setShowOnAmendModal)}
                        >
                            <BorderColor />
                        </IconButton>
                        <IconButton
...
export default CessionSecondLevelQueueGrid
