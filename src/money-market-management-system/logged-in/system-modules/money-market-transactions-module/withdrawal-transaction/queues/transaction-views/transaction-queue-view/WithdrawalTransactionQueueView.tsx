...
const WithdrawalTransactionQueueView = observer(({ isVisible }: IProps) => {
        ...
        <ErrorBoundary>
            <div className="view-modal custom-modal-style uk-modal-dialog uk-width-4-5">
                ...
                <div className="uk-text-right">
                    ...
                    <button onClick={submitForFirstLevelApproval} className="btn btn-primary" disabled={loading} >
...
export default WithdrawalTransactionQueueView;