...
const SecondLevelWithdrawalTransactionQueueView = observer(() => {
    ...
    const submitForFirstLevelApproval = async () => {
        if (withdrawalTransaction.accountNumber !== "" && withdrawalTransaction.allocationStatus === "Submitted for Deletion") {
            ...
            const newWithdrawalTransaction: IWithdrawalTransaction = {
                ...
                firstLevelApprover: withdrawalTransaction.firstLevelApprover,
            ...
            try {
                ...
                swal({
                    icon: "success",
                    text: "Transaction Successfully Approved For Payment",
                });
            } catch (error) {
            }
        }
...
export default SecondLevelWithdrawalTransactionQueueView;