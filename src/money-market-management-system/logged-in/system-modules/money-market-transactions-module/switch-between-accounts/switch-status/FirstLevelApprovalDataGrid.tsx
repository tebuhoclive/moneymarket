...
import SwitchesFirstLevelTransactionQueueView from "../../../../dialogs/transactions/switch/view-transaction-modal/SwitchesFirstLevelTransactionQueueView";
import { Visibility } from '@mui/icons-material';
import { TransactionType } from "../../../../shared/components/transaction-process-flag/TransactionProcess";
import SwitchesCloseOutsFirstLevelTransactionQueueView from "../../../../dialogs/transactions/switch/view-transaction-modal/SwitchesCloseOutsFirstLevelTransactionQueueView";
...
const FirstLevelApprovalDataGrid = observer(({ data, transactionFilter }: IProps) => {
      ...
      <DataGridToolbar
        rightControls={
          <button
            ...
            onClick={submitForSecondLevelApproval}
          >
            {loadingSubmit ? (
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      width: 200,
      renderCell: (params) => {
        const fieldExists = 'returnNote' in params.row;
  ...
  return (
    <div className="grid">
      ...
      <Modal
        ...
        {showOnSubmitModal &&
          <SwitchesFirstLevelTransactionQueueView setVisible={setShowOnSubmitModal} />
        }
      </Modal>
      ...
      <Modal
        ...
        {showOnSubmitModal &&
          <SwitchesCloseOutsFirstLevelTransactionQueueView setVisible={setShowOnSubmitModal} />
        }
      </Modal>
    </div>
  );
...
export default FirstLevelApprovalDataGrid;
