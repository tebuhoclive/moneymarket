...
import SwitchesSecondLevelTransactionQueueView from "../../../../dialogs/transactions/switch/view-transaction-modal/SwitchesSecondLevelTransactionQueueView";
import SwitchesCloseOutSecondLevelTransactionQueueView from "../../../../dialogs/transactions/switch/view-transaction-modal/SwitchesCloseOutSecondLevelTransactionQueueView";
import { onCompletedSwitch } from "../../../../dialogs/transactions/client-deposit-allocation/view-transaction-modal/complete-transaction-process/ProcessTransactions";
import ProgressBar from "../../../../../../shared/components/progress/Progress";
import { processSwitchTransactions } from "./procsssing/ProcessSwitchTransactions";
...
const SecondLevelApprovalDataGrid = observer(({ data, transactionFilter }: IProps) => {
    ...
    for (const transaction of selectedTransactions) {
      if (transaction.reasonForDeleting !== "" && transaction.transactionType === "Manual Switch") {
        ...
        try {
          ...
          await processSwitchTransactions(newTransaction, api, store);
          completedCount++;
          const progress = (completedCount / totalTransactions) * 100;
          setProgressPercentage(progress);
        } catch (error) {
          console.log("Error approving transaction");
        }
        ...
        try {
          await api.switch.update(newTransaction);
          // onCompletedSwitch(newTransaction, api, store);
          completedCount++;
          const progress = (completedCount / totalTransactions) * 100;
          setProgressPercentage(progress);
        } catch (error) {
  ...
  return (
    <div className="grid">
      ...
      <Modal
        ...
        {showOnSubmitModal &&
          <SwitchesSecondLevelTransactionQueueView
            setVisible={setShowOnSubmitModal} />
        }
      </Modal>
      ...
      <Modal
        ...
        {showOnSubmitModal &&
          <SwitchesCloseOutSecondLevelTransactionQueueView
            setVisible={setShowOnSubmitModal} />
        }
      </Modal>
...
export default SecondLevelApprovalDataGrid;