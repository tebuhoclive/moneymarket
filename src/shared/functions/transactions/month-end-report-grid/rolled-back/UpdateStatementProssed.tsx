...
import { getFilteredStatementTransactions, getStatementTotalDays, getStatementTotalDistribution, calculateInterest, getTotalDaysInMonth, getFilteredStatementMonthEndTransactions } from "../../Statement";
...
export const UpdateStatementProcessed = (props: IProps) => {
    ...
    async function updateInterestAccruedAndTotalDays1() {
        ...
        try {
            ...
            const filteredStatementTransactions = getFilteredStatementMonthEndTransactions(startDate, endDate, statementTransactionsAsJson, 0);
            ...
            // await api.mma.updateDaysAndInterestProcessed(moneyMarketAccountId, totalDays, totalDistribution, `${month}`, `${year}`);

            await api.mma.updateDaysAndInterestProcessed(moneyMarketAccountId, totalDays, totalDistribution, `R5`, `${year}`);
            swal({
                icon: 'warning',
