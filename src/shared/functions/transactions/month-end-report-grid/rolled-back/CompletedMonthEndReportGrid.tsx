...
import NormalClientStatement from "./NormalClientStatement";
...
export const CompletedReportMonthEndGrid = observer(({ data, year, month }: IProps) => {
    ...
    const onUpdateInterest = (id: string) => {
        ...
        showModalFromId(MODAL_NAMES.BACK_OFFICE.NORMAL_STATEMENT_MODAL);
    }


    // const onCancel = () => {
    //     hideModalFromId(MODAL_NAMES.BACK_OFFICE.NORMAL_STATEMENT_MODAL);
    ...
    return (
        <div className="grid">
            ...
            <Modal modalId={MODAL_NAMES.BACK_OFFICE.NORMAL_STATEMENT_MODAL}>
                <div className="view-modal custom-modal-style uk-modal-dialog uk-modal-body uk-width-1-1">
                    ...
                    <NormalClientStatement moneyMarketAccountId={selectedId} startDate={startDate} endDate={endDate}
                    />
                </div>
            </Modal>
