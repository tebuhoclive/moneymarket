...
const filePath = './ncpi_index.xlsx';
...
class Bond {
    ...
    price(settlementDate: Date, yieldToMaturity: number): number {
        ...
        if (
            ...
            const a = yieldToMaturity / this.frequency / 100; //Represents the yield to maturity per period (annual rate divided by frequency).
            console.log("Cum A", a);

            const b = Math.pow(1 + a, G); //Represents the coupon rate of the bond.
            console.log("Cum B", b);

            const c = this.couponRate; //Represents a calculation involving the inverse of b.
            console.log("Cum C", c);

            const d = 100 / b; //Represents a portion of the coupon rate adjusted for frequency.
            console.log("Cum D", d);

            const e = c / this.frequency / 100; //Represents a coefficient used in the calculation.
            console.log("Cum E", e);

            const g = e / (b * a); //Represents the result of a calculation involving (1 + a).
            console.log("Cum G", g);
        ...
        // ex
            ...
            const b = (E / 365) * (yieldToMaturity / 100);
...
// Tests
const settlementDate = new Date(2024, 3, 16);
...
/** System must calculate the clean price and accrued interest 
...
//Namibia Consumer Price Inflation (NCPI)
// Update monthly
