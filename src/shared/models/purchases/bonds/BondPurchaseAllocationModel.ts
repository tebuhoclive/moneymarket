...
export const defaultBondPurchaseAllocation: IBondPurchaseAllocation = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IBondPurchaseAllocation {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultBondPurchaseAllocationColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const BondColumnNames = {
    id: "Bond Purchase Allocation ID", // leave here for DEV User
...
export default class BondPurchaseAllocationModel {
    private allocation: IBondPurchaseAllocation;

    constructor(private store: AppStore, allocation: IBondPurchaseAllocation) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IBondPurchaseAllocation {
