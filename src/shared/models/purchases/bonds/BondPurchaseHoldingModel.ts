...
export const defaultBondPurchaseHolding: IBondPurchaseHolding = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IBondPurchaseHolding {
    id: string,
    clientId?: string;
    clientName: string;
    ...
    confirmation: string;
    status: IBondPurchaseStatus
}

export const defaultBondPurchaseHoldingColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const BondColumnNames = {
    id: "Bond Purchase Holding ID", // leave here for DEV User
...
export default class BondPurchaseHoldingModel {
    private allocation: IBondPurchaseHolding;

    constructor(private store: AppStore, allocation: IBondPurchaseHolding) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IBondPurchaseHolding {
