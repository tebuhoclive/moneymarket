...
//import { IUnitTrustPurchaseStatus } from "./PurchaseUnitTrustModel";

export const defaultUnitTrustPurchaseTransaction: IUnitTrustPurchaseTransaction = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IUnitTrustPurchaseTransaction {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultUnitTrustPurchaseTransactionColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const UnitTrustColumnNames = {
    id: "Unit Trust Purchase Transaction ID", // leave here for DEV User
...
export default class UnitTrustPurchaseTransactionModel {
    private allocation: IUnitTrustPurchaseTransaction;

    constructor(private store: AppStore, allocation: IUnitTrustPurchaseTransaction) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IUnitTrustPurchaseTransaction {
