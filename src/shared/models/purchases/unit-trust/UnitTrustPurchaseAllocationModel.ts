...
export const defaultUnitTrustPurchaseAllocation: IUnitTrustPurchaseAllocation = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IUnitTrustPurchaseAllocation {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultUnitTrustPurchaseAllocationColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const UnitTrustColumnNames = {
    id: "Unit Trust Purchase Allocation ID", // leave here for DEV User
...
export default class UnitTrustPurchaseAllocationModel {
    private allocation: IUnitTrustPurchaseAllocation;

    constructor(private store: AppStore, allocation: IUnitTrustPurchaseAllocation) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IUnitTrustPurchaseAllocation {
