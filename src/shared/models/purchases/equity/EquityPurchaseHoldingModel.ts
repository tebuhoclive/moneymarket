...
import { IEquityPurchaseExecutionStatus } from "./PurchaseEquityModel";

export const defaultEquityPurchaseHolding: IEquityPurchaseHolding = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IEquityPurchaseHolding {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultEquityPurchaseHoldingColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const EquityColumnNames = {
    id: "Equity Purchase Holding ID", // leave here for DEV User
...
export default class EquityPurchaseHoldingModel {
    private allocation: IEquityPurchaseHolding;

    constructor(private store: AppStore, allocation: IEquityPurchaseHolding) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IEquityPurchaseHolding {
