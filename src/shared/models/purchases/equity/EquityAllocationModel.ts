...
export const defaultEquityPurchaseAllocation: IEquityPurchaseAllocation = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IEquityPurchaseAllocation {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultEquityPurchaseAllocationColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const EquityColumnNames = {
    id: "Equity Purchase Allocation ID", // leave here for DEV User
...
export default class EquityPurchaseAllocationModel {
    private allocation: IEquityPurchaseAllocation;

    constructor(private store: AppStore, allocation: IEquityPurchaseAllocation) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IEquityPurchaseAllocation {
