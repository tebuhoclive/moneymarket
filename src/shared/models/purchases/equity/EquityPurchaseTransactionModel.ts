...
//import { IEquityPurchaseStatus } from "./PurchaseEquityModel";

export const defaultEquityPurchaseTransaction: IEquityPurchaseTransaction = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IEquityPurchaseTransaction {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultEquityPurchaseTransactionColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const EquityColumnNames = {
    id: "Equity Purchase Transaction ID", // leave here for DEV User
...
export default class EquityPurchaseTransactionModel {
    private allocation: IEquityPurchaseTransaction;

    constructor(private store: AppStore, allocation: IEquityPurchaseTransaction) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IEquityPurchaseTransaction {
