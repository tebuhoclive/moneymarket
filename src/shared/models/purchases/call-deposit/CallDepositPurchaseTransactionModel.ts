...
//import { ICallDepositPurchaseStatus } from "./PurchaseCallDepositModel";

export const defaultCallDepositPurchaseTransaction: ICallDepositPurchaseTransaction = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface ICallDepositPurchaseTransaction {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultCallDepositPurchaseTransactionColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const CallDepositColumnNames = {
    id: "Call Deposit Purchase Transaction ID", // leave here for DEV User
...
export default class CallDepositPurchaseTransactionModel {
    private allocation: ICallDepositPurchaseTransaction;

    constructor(private store: AppStore, allocation: ICallDepositPurchaseTransaction) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): ICallDepositPurchaseTransaction {
