...
export const defaultCallDepositPurchaseAllocation: ICallDepositPurchaseAllocation = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface ICallDepositPurchaseAllocation {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultCallDepositPurchaseAllocationColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const CallDepositColumnNames = {
    id: "TB Purchase Allocation ID", // leave here for DEV User
...
export default class CallDepositPurchaseAllocationModel {
    private allocation: ICallDepositPurchaseAllocation;

    constructor(private store: AppStore, allocation: ICallDepositPurchaseAllocation) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): ICallDepositPurchaseAllocation {
