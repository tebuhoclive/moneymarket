...
export const defaultFixedDepositPurchaseTransaction: IFixedDepositPurchaseTransaction = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IFixedDepositPurchaseTransaction {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultTBPurchaseTransactionColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const FixedDepositColumnNames = {
    id: "Fixed Deposit Purchase Transaction ID", // leave here for DEV User
...
export default class FixedDepositPurchaseTransactionModel {
    private allocation: IFixedDepositPurchaseTransaction;

    constructor(private store: AppStore, allocation: IFixedDepositPurchaseTransaction) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IFixedDepositPurchaseTransaction {
