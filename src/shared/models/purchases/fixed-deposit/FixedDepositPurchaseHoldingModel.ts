...
import { IFixedDepositPurchaseExecutionStatus } from "./PurchaseFixedDepositModel";

export const defaultFixedDepositPurchaseHolding: IFixedDepositPurchaseHolding = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface IFixedDepositPurchaseHolding {
    id: string,
    clientId?: string;
    clientName: string;
    ...
    confirmation: string;
    status: IFixedDepositPurchaseExecutionStatus
}

export const defaultFixedDepositPurchaseHoldingColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const FixedDepositColumnNames = {
    id: "FixedDeposit Purchase Holding ID", // leave here for DEV User
...
export default class FixedDepositPurchaseHoldingModel {
    private allocation: IFixedDepositPurchaseHolding;

    constructor(private store: AppStore, allocation: IFixedDepositPurchaseHolding) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): IFixedDepositPurchaseHolding {
