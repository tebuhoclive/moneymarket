...
export const defaultTreasuryBillPurchaseTransaction: ITreasuryBillPurchaseTransaction = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface ITreasuryBillPurchaseTransaction {
    id: string,
    clientId?: string;
    clientName: string;
...
export const TreasuryBillColumnNames = {
    id: "TB Purchase Transaction ID", // leave here for DEV User
...
export default class TreasuryBillPurchaseTransactionModel {
    private allocation: ITreasuryBillPurchaseTransaction;

    constructor(private store: AppStore, allocation: ITreasuryBillPurchaseTransaction) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): ITreasuryBillPurchaseTransaction {
