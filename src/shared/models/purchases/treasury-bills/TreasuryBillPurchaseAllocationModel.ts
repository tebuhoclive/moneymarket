...
export const defaultTreasuryBillPurchaseAllocation: ITreasuryBillPurchaseAllocation = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface ITreasuryBillPurchaseAllocation {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultTBPurchaseAllocationColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export default class TreasuryBillPurchaseAllocationModel {
    private allocation: ITreasuryBillPurchaseAllocation;

    constructor(private store: AppStore, allocation: ITreasuryBillPurchaseAllocation) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): ITreasuryBillPurchaseAllocation {
