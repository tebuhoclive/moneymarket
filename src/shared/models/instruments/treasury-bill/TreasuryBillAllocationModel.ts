...
export const defaultTreasuryBillAllocation: ITreasuryBillAllocation = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface ITreasuryBillAllocation {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultTreasuryBillAllocationColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const TreasuryBillColumnNames = {
    id: "TB  Allocation ID", // leave here for DEV User
...
export default class TreasuryBillAllocationModel {
    private allocation: ITreasuryBillAllocation;

    constructor(private store: AppStore, allocation: ITreasuryBillAllocation) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): ITreasuryBillAllocation {
