...
export const defaultTreasuryBillHolding: ITreasuryBillHolding = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface ITreasuryBillHolding {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultTBHoldingColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const TreasuryBillColumnNames = {
    id: "TB  Holding ID", // leave here for DEV User
...
export default class TreasuryBillHoldingModel {
    private allocation: ITreasuryBillHolding;

    constructor(private store: AppStore, allocation: ITreasuryBillHolding) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): ITreasuryBillHolding {
