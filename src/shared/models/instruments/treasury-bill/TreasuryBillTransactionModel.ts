...
export const defaultTreasuryBillTransaction: ITreasuryBillTransaction = {
    id: "",
    clientId: "",
    clientName: "",
...
export interface ITreasuryBillTransaction {
    id: string,
    clientId?: string;
    clientName: string;
...
export const defaultTBTransactionColumnVisibility = {
    id: false,
    clientId: true,
    clientName: true,
...
export const TreasuryBillColumnNames = {
    id: "TB  Transaction ID", // leave here for DEV User
...
export default class TreasuryBillTransactionModel {
    private allocation: ITreasuryBillTransaction;

    constructor(private store: AppStore, allocation: ITreasuryBillTransaction) {
        makeAutoObservable(this);
        this.allocation = allocation;
    }

    get asJson(): ITreasuryBillTransaction {
